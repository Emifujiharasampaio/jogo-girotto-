este repositório contém o desenvolvimento de três jogos interativos, concebidos como uma atividade de extensão universitária.
o objetivo central foi aprimorar as bases fundamentais da programação utilizando a linguagem c.
...
utilizamos a ia na parte de um laço de repetição no menu para caso alguem digitasse uma letra
